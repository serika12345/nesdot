...
export const ShareIcon: React.FC<IconProps> = ({ size = 18, className }) => {
    return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...baseProps}>
...
export const ChevronIcon: React.FC<IconProps & { open?: boolean }> = ({ size = 16, className, open = false }) => {
    return (
        <svg
            className={className}
            width={size}
