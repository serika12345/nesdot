...
export const PaletteCard = styled.div<{ active?: boolean }>`
  ...
  border: 1px solid
    ${(p) =>
      p.active ? "rgba(15, 118, 110, 0.18)" : "rgba(148, 163, 184, 0.16)"};
  box-shadow: ${(p) =>
    p.active ? "0 18px 30px rgba(15, 118, 110, 0.12)" : "none"};
`;
...
export const PaletteStatus = styled.span<{ active?: boolean }>`
  ...
  background: ${(p) =>
    p.active ? "rgba(15, 118, 110, 0.12)" : "rgba(148, 163, 184, 0.1)"};
  border: 1px solid
    ${(p) =>
      p.active ? "rgba(15, 118, 110, 0.16)" : "rgba(148, 163, 184, 0.14)"};
`;
...
export const SlotGroup = styled.div<{ active?: boolean }>`
  ...
  border-radius: 18px;
  background: ${(p) =>
    p.active ? "rgba(15, 118, 110, 0.1)" : "rgba(255, 255, 255, 0.58)"};
  border: 1px solid
    ${(p) =>
      p.active ? "rgba(15, 118, 110, 0.16)" : "rgba(148, 163, 184, 0.1)"};
`;
...
export const SlotButton = styled.button<{
  ...
  cursor: pointer;
  border: ${(p) =>
    p.active ? "3px solid #0f766e" : "1px solid rgba(148, 163, 184, 0.28)"};
  box-shadow: ${(p) =>
    p.active
...
export const ColorCell = styled.button<{ bg: string; active?: boolean }>`
  ...
  cursor: pointer;
  border: ${(p) =>
    p.active ? "3px solid #0f172a" : "1px solid rgba(15, 23, 42, 0.08)"};
  box-shadow: ${(p) =>
    p.active
