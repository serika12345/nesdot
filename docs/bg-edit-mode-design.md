...
- `WorkMode` には `bg` が追加済みで、[../src/presentation/App.tsx](../src/presentation/App.tsx)、[../src/presentation/components/common/menu/FileMenuBar.tsx](../src/presentation/components/common/menu/FileMenuBar.tsx)、[../src-tauri/src/lib.rs](../src-tauri/src/lib.rs) から切り替えられます。
- BG モード本体は [../src/presentation/components/bgMode/core/BgMode.tsx](../src/presentation/components/bgMode/core/BgMode.tsx) / [../src/presentation/components/bgMode/panels/BgModeWorkspacePanel.tsx](../src/presentation/components/bgMode/panels/BgModeWorkspacePanel.tsx) です。
- 画面配置モードの BG 編集は [../src/presentation/components/screenMode/panels/ScreenModeWorkspacePanel.tsx](../src/presentation/components/screenMode/panels/ScreenModeWorkspacePanel.tsx) と [../src/presentation/components/screenMode/hooks/useScreenModeBackgroundEditingState.ts](../src/presentation/components/screenMode/hooks/useScreenModeBackgroundEditingState.ts) が担当します。
...
- できること: タイル選択、1 ピクセルずつの描画、消しゴム、プレビュー色の切り替え
- できないこと: タイル並べ替え、削除、別保存形式、画面配置への直接ドラッグ配置
...
- ボタンから [../src/presentation/components/screenMode/dialogs/ScreenModeBackgroundTilePickerDialog.tsx](../src/presentation/components/screenMode/dialogs/ScreenModeBackgroundTilePickerDialog.tsx) を開きます
